...
/// </summary>
public sealed class ProjectActivationRaceTests : IClassFixture<FilmStudioApiFactory>, IAsyncLifetime
{
    ...
    public ProjectActivationRaceTests(FilmStudioApiFactory factory)
    {
        _factory = factory;
