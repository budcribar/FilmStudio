...
public sealed class Stage2PlannerAutomationTests
{
    ...
    public async Task ShotPlanRefiner_UpdatesVisualPromptsAndContinuationSources()
    {
        ...
        var opts = Options.Create(new FilmStudioOptions { ClassifyShotPlanRefineWithChat = true });
    ...
    {
        var fountainPath = @"c:\Users\budcr\source\repos\FilmStudio\projects\TellTaleHeartV7\source\screenplay.fountain";
