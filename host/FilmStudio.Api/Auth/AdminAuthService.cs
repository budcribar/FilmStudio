...
public sealed class AdminAuthService : IAdminAuthService
{
    ...
    public AdminAuthService(IOptions<FilmStudioOptions> opts, IHostEnvironment env)
    {
    ...
    private bool VerifyPassword(string password)
    {
        ...
        var envPw = Environment.GetEnvironmentVariable("FILMSTUDIO_ADMIN_PASSWORD");
    ...
    {
        ValidateIssuer = true,
        ValidIssuer = "FilmStudio.Api",
        ValidateAudience = true,
        ValidAudience = "FilmStudio",
