...
internal static class Stage1FountainLifecycle
{
    ...
    private sealed class Operation(IChatClient chat) : IModelOperation<Stage1FountainRequest, string>
    {
    ...
    private sealed class Parser : IModelResponseParser<string, Stage1FountainResponse>
    {
    ...
    private sealed class Validator(Func<string, IReadOnlyList<ModelValidationIssue>> validate)
    ...
    private sealed class Fallback : IDeterministicFallback<Stage1FountainRequest, Stage1FountainResponse>
    {
