...
public class CreditsGeneratorService
{
        ...
        CancellationToken ct = default)
    {
        ...
        // Save credits MP4 file to server project directory so client media sync delivers MP4 files to client folder
        try
        {
        ...
        {
            _logger.LogWarning(ex, "Could not save credits MP4 bytes to server project directory");
        }
